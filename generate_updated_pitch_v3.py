...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* SLIDE 1 COVER (Left icon removed, Right shows user FocusLingua icon image) */
    .hero-slide-body {
      display: flex;
      justify-content: space-between;
      align-items: center;
    ...
    .hero-icon-img {
      ...
      height: 320px;
      object-fit: contain;
      filter: drop-shadow(0 20px 35px rgba(30, 58, 43, 0.18));
    ...
    /* SLIDE 2 AGENDA (Top to bottom in two columns) */
    .agenda-two-cols {
      display: grid;
      grid-template-columns: 1fr 1fr;
      gap: 20px;
  ...
  <div class="presentation-layout">
    ...
    <aside class="pitch-sidebar">
      <div class="sidebar-brand">
        <img src="extracted_images/focuslingua_icon.png" alt="FocusLingua" class="brand-icon-mini">
    ...
    <main class="deck-container">
      ...
      <!-- =========================================================================
           SLIDE 1: COVER (封面 - 首頁圖標只留下使用者指定圖檔，左邊文字圖標刪除)
           ========================================================================= -->
      <section class="slide-card active" id="slide-1">
        ...
        <div class="hero-slide-body">
          <div style="flex: 1; z-index: 2;">
            ...
            <!-- Title Cluster without left icon -->
          ...
          <!-- Right: FocusLingua Official Brand Icon Only -->
          <div class="hero-icon-showcase">
            <img src="extracted_images/focuslingua_icon.png" alt="FocusLingua Icon" class="hero-icon-img">
          </div>
        </div>
      ...
      <!-- =========================================================================
           SLIDE 2: CONTENT (簡報目錄 - 順序從上到下分兩排)
           ========================================================================= -->
      <section class="slide-card" id="slide-2">
        ...
        <div class="slide-body">
          <div class="agenda-two-cols">
            <!-- Left Column: 01 to 05 (Top to Bottom) -->
            ...
            <!-- Right Column: 06 to 10 (Top to Bottom) -->
            <div class="agenda-col">
        ...
        <div class="slide-footer">
          ...
          <span>兩排縱向順序排列 ｜ 點擊任一項目即可直接跳轉</span>
        </div>
      </section>


      <!-- =========================================================================
           SLIDE 3: ABOUT PRESENTER (自我介紹 - 圖片旋轉直立)
           ========================================================================= -->
      ...
      <!-- =========================================================================
           SLIDE 5: MAIN POINTS (企業實務痛點 與 目前困境 - 左右調換、小標對齊、視覺平衡)
           ========================================================================= -->
      ...
      <!-- =========================================================================
           SLIDE 7: PRODUCT EVOLUTION (產品演進脈絡分析)
           ========================================================================= -->
      ...
      <!-- =========================================================================
           SLIDE 9: COST-BENEFIT & ROI (導入效益分析 - 無任何數據、補充文字限兩行、移除多餘標籤)
           ========================================================================= -->
      <section class="slide-card" id="slide-9">
        ...
        <div class="slide-body">
          <div class="grid-2">
            <!-- Left Card: BEFORE 導入前 (無數據，文字限兩行) -->
            <div class="content-box-pill" style="border-top: 4px solid #DC2626; background: #FFFBFA;">
              <div style="margin-bottom:14px;">
                <span class="pill-badge" style="background:#FEE2E2; color:#DC2626; margin-bottom:0; font-size:0.88rem; padding:5px 16px; font-weight:800;">
                  <i class="fa-solid fa-circle-xmark" style="margin-right:6px;"></i> BEFORE 導入前
                </span>
              </div>

              <!-- Item 1 -->
              <div style="margin-bottom:18px;">
                <div style="font-size:1.02rem; font-weight:800; color:#991B1B; margin-bottom:4px; display:flex; align-items:center; gap:6px;">
                  <i class="fa-solid fa-clock-rotate-left"></i> 備課負擔沉重，資源嚴重錯配
                </div>
                <div class="card-p" style="color:#7F1D1D; font-size:0.88rem; line-height:1.65;">
              ...
              <div style="margin-bottom:18px;">
                <div style="font-size:1.02rem; font-weight:800; color:#991B1B; margin-bottom:4px; display:flex; align-items:center; gap:6px;">
                  <i class="fa-solid fa-brain"></i> 常態教材偏難，容易產生挫折
                </div>
                <div class="card-p" style="color:#7F1D1D; font-size:0.88rem; line-height:1.65;">
              ...
              <div>
                <div style="font-size:1.02rem; font-weight:800; color:#991B1B; margin-bottom:4px; display:flex; align-items:center; gap:6px;">
                  <i class="fa-solid fa-box-archive"></i> 缺乏行為數據，難以爭取特教資源
                </div>
                <div class="card-p" style="color:#7F1D1D; font-size:0.88rem; line-height:1.65;">
            ...
            <!-- Right Card: AFTER 導入後 (無「後預期效益」贅字，無數據，文字限兩行) -->
            <div class="content-box-pill" style="border-top: 4px solid var(--sage-primary); background: #FAFCFA;">
              <div style="margin-bottom:14px;">
                <span class="pill-badge pill-green" style="margin-bottom:0; font-size:0.88rem; padding:5px 16px; font-weight:800;">
                  <i class="fa-solid fa-circle-check" style="margin-right:6px;"></i> AFTER 導入後
                </span>
              </div>

              <!-- Item 1 -->
              <div style="margin-bottom:18px;">
                <div style="font-size:1.02rem; font-weight:800; color:var(--sage-primary); margin-bottom:4px; display:flex; align-items:center; gap:6px;">
                  <i class="fa-solid fa-bolt"></i> 備課效率顯著提升
                </div>
                <div class="card-p" style="font-size:0.88rem; line-height:1.65;">
              ...
              <div style="margin-bottom:18px;">
                <div style="font-size:1.02rem; font-weight:800; color:var(--sage-primary); margin-bottom:4px; display:flex; align-items:center; gap:6px;">
                  <i class="fa-solid fa-seedling"></i> 課堂即時掌握核心詞彙
                </div>
                <div class="card-p" style="font-size:0.88rem; line-height:1.65;">
              ...
              <div>
                <div style="font-size:1.02rem; font-weight:800; color:var(--sage-primary); margin-bottom:4px; display:flex; align-items:center; gap:6px;">
                  <i class="fa-solid fa-chart-line"></i> 打開特教與機構合作新市場
                </div>
                <div class="card-p" style="font-size:0.88rem; line-height:1.65;">
        ...
        <div class="slide-footer">
          ...
          <span>前後核心轉變：由繁瑣備課與挫折堆疊 ➔ 轉化為高效審核、微型消化與特教合作藍海</span>
        </div>
      </section>


      <!-- =========================================================================
           SLIDE 10: FUTURE SCALABILITY (未來擴散性與再精進 - LiveABC 改為出版教材，文字大幅簡化)
           ========================================================================= -->
      <section class="slide-card" id="slide-10">
        ...
        <div class="slide-header">
          <div>
            ...
            <h2 class="slide-title">未來擴散性與再精進方案</h2>
            <p class="slide-subtitle">從單一英語教材，延伸至多元學科輔助與特教支持生態</p>
          </div>
        </div>
        ...
        <div class="slide-body">
          <div class="grid-3">
            <!-- Card 1 -->
            <div class="content-box-pill" style="border-top: 4px solid var(--sage-primary);">
              <div style="background:var(--sage-light); color:var(--sage-primary); font-size:0.82rem; font-weight:800; padding:6px 12px; border-radius:8px; margin-bottom:14px; align-self:flex-start;">
                一、跨學科延伸
              </div>
              <div class="card-h" style="font-size:1.15rem; margin-bottom:10px;">
                拓展至國語與數學等科目
              </div>
              <div class="card-p" style="line-height:1.75; font-size:0.92rem;">
            ...
            <!-- Card 2 -->
            <div class="content-box-pill" style="border-top: 4px solid var(--terracotta-cta);">
              <div style="background:var(--terracotta-light); color:var(--terracotta-cta); font-size:0.82rem; font-weight:800; padding:6px 12px; border-radius:8px; margin-bottom:14px; align-self:flex-start;">
                二、智慧狀態感知
              </div>
              <div class="card-h" style="font-size:1.15rem; margin-bottom:10px;">
                偵測專注疲勞並動態調適
            ...
            <div class="content-box-pill" style="border-top: 4px solid var(--blue-accent);">
              <div style="background:var(--blue-light); color:var(--blue-accent); font-size:0.82rem; font-weight:800; padding:6px 12px; border-radius:8px; margin-bottom:14px; align-self:flex-start;">
                三、生態圈連結
              </div>
              <div class="card-h" style="font-size:1.15rem; margin-bottom:10px;">
                出版教材串聯學校與家長
        ...
        <div class="slide-footer">
          ...
          <span>簡單清晰三大主軸：跨學科拓展 × 智慧疲勞感知 × 出版教材特教生態圈</span>
        </div>
      </section>
      ...
      <section class="slide-card" id="slide-12">
        ...
        <div class="slide-body" style="display:flex; flex-direction:column; justify-content:center; align-items:center; text-align:center; min-height:550px;">
          <img src="extracted_images/focuslingua_icon.png" alt="FocusLingua Icon" style="width:110px; height:110px; object-fit:contain; margin-bottom:20px; filter:drop-shadow(0 10px 25px rgba(45,90,67,0.25));">
...
print('Successfully generated pitch_presentation.html v3!')
