...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* SLIDE 1 COVER BRAND ICON CARD (Replaces photo) */
    .hero-slide-body {
      display: flex;
      justify-content: space-between;
      align-items: center;
    ...
    /* Right Brand Showcase Card on Slide 1 */
    .hero-brand-card {
      width: 440px;
      background: linear-gradient(145deg, #FFFFFF 0%, #F5F8F5 100%);
      border: 2px solid #E2EADD;
      border-radius: 32px;
      padding: 40px 32px;
      display: flex;
      flex-direction: column;
      align-items: center;
      text-align: center;
      box-shadow: 0 20px 45px rgba(45, 90, 67, 0.12);
      position: relative;
    }
    ...
    .fl-hero-icon-large {
      width: 130px;
      height: 130px;
      background: linear-gradient(135deg, #2D5A43 0%, #153423 100%);
      border-radius: 36px;
      display: flex;
      align-items: center;
      justify-content: center;
      position: relative;
      box-shadow: 0 16px 36px rgba(21, 52, 35, 0.35), inset 0 2px 4px rgba(255, 255, 255, 0.4);
      border: 3px solid rgba(255, 255, 255, 0.3);
      margin-bottom: 20px;
    }

    .fl-hero-icon-large-text {
      color: #FFFFFF;
      font-size: 3.8rem;
      font-weight: 900;
      font-family: 'Plus Jakarta Sans', sans-serif;
    ...
    .fl-hero-icon-large-sparkle {
      ...
      justify-content: center;
      font-size: 1.1rem;
      box-shadow: 0 4px 12px rgba(232, 163, 61, 0.45);
    }
  ...
  <div class="presentation-layout">
    ...
    <aside class="pitch-sidebar">
      ...
      <nav class="sidebar-nav">
        <div class="sidebar-section-title">簡報章節 (12 SLIDES)</div>
        ...
        <button class="side-nav-btn" id="sideNav-5" onclick="goToSlide(5)">
          ...
          <span class="nav-label">痛點與目前困境</span>
        </button>
        ...
        <button class="side-nav-btn" id="sideNav-7" onclick="goToSlide(7)">
          ...
          <span class="nav-label">產品演進脈絡</span>
        </button>
        ...
        <button class="side-nav-btn" id="sideNav-9" onclick="goToSlide(9)">
          ...
          <span class="nav-label">預測效益分析 (B/A)</span>
        </button>
        ...
        <button class="side-nav-btn" id="sideNav-12" onclick="goToSlide(12)">
          <span class="nav-idx">12</span>
      ...
      <div class="sidebar-bottom">
        <div class="sidebar-pager">
          ...
          <span class="side-counter" id="slideIndicator">01 / 12</span>
    ...
    <main class="deck-container">
      ...
      <!-- =========================================================================
           SLIDE 1: COVER (封面 - 照片替換為 FocusLingua 品牌圖示)
           ========================================================================= -->
      <section class="slide-card active" id="slide-1">
        ...
        <div class="hero-slide-body">
          ...
          <!-- Brand Logo Showcase Card (Replaced User Photo with FocusLingua Icon Graphic) -->
          <div class="hero-brand-card">
            <div class="fl-hero-icon-large" title="FocusLingua 旗艦識別">
              <span class="fl-hero-icon-large-text">FL</span>
              <div class="fl-hero-icon-large-sparkle"><i class="fa-solid fa-sparkles"></i></div>
            </div>
            <div class="hero-brand-badge-title">FocusLingua Edu</div>
            <div class="hero-brand-badge-tag">微型多感官學習對話系統</div>
            
            <div class="hero-brand-feature-pills">
              <div class="h-pill"><i class="fa-solid fa-hourglass-half"></i> 90 秒沙漏微任務專注沙盒</div>
              <div class="h-pill"><i class="fa-solid fa-headphones"></i> 多感官無干擾片語伴讀卡</div>
              <div class="h-pill"><i class="fa-solid fa-chalkboard-user"></i> 教師端 AI 30 秒自動出題切片</div>
              <div class="h-pill"><i class="fa-solid fa-shield-halved"></i> 課堂防沉迷 10 分鐘護眼鎖定</div>
            </div>
          </div>
        </div>
        ...
        <div class="slide-body">
          <div class="agenda-grid">
            ...
            <div class="agenda-item-card" onclick="goToSlide(5)">
              ...
              <div class="agenda-item-text">企業實務痛點與目前困境</div>
            </div>
            <div class="agenda-item-card" onclick="goToSlide(6)">
              <div class="agenda-item-num">04</div>
              <div class="agenda-item-text">專案架構與微型展示</div>
            </div>
            <div class="agenda-item-card" onclick="goToSlide(7)">
              <div class="agenda-item-num">05</div>
              <div class="agenda-item-text">產品演進脈絡分析</div>
            </div>
            <div class="agenda-item-card" onclick="goToSlide(8)" style="border-color:var(--terracotta-cta); background:#FAF5F0;">
              <div class="agenda-item-num" style="background:#FDF0EC; color:var(--terracotta-cta);">06</div>
              <div class="agenda-item-text" style="color:var(--terracotta-cta);">雙端實操模擬 <small style="font-size:0.72rem; background:var(--terracotta-cta); color:#fff; padding:2px 8px; border-radius:10px; margin-left:6px;">LIVE DEMO</small></div>
            </div>
            <div class="agenda-item-card" onclick="goToSlide(9)">
              <div class="agenda-item-num">07</div>
              <div class="agenda-item-text">導入效益分析 (Before vs After)</div>
            </div>
            <div class="agenda-item-card" onclick="goToSlide(10)">
              <div class="agenda-item-num">08</div>
              <div class="agenda-item-text">未來擴散性與再精進</div>
            </div>
            <div class="agenda-item-card" onclick="goToSlide(11)">
              <div class="agenda-item-num">09</div>
              <div class="agenda-item-text">個人學習成果與反思</div>
            </div>
            <div class="agenda-item-card" onclick="goToSlide(12)">
              <div class="agenda-item-num">10</div>
              <div class="agenda-item-text">結尾致謝與交流</div>
            </div>
          </div>
        </div>

        <div class="slide-footer">
          <span>簡報目錄 ｜ Slide 02 / 12</span>
      ...
      <!-- =========================================================================
           SLIDE 3: ABOUT PRESENTER (自我介紹 - 圖片向右旋轉 90 度呈正常直立)
           ========================================================================= -->
      <section class="slide-card" id="slide-3">
        ...
        <div class="slide-body">
          <div class="grid-2" style="align-items: center;">
            <!-- Left Profile Card with Rotated Photo -->
            <div class="profile-card-left">
              <div class="profile-photo-box">
                <img src="extracted_images/anna_photo_rotated.jpg" alt="陳詠芸" style="width:100%; height:100%; object-fit:cover; object-position:center 25%;">
              </div>
        ...
        <div class="slide-footer">
          <span>ABOUT PRESENTER ｜ Slide 03 / 12</span>
      ...
      <section class="slide-card" id="slide-4">
        ...
        <div class="slide-footer">
          <span>MOTIVATION ｜ Slide 04 / 12</span>
      ...
      <!-- =========================================================================
           SLIDE 5: MAIN POINTS (企業實務痛點 與 目前困境 - 左右調換、小標對齊、內文增補平衡)
           ========================================================================= -->
      <section class="slide-card" id="slide-5">
        ...
        <div class="slide-header">
          <div>
            ...
            <p class="slide-subtitle">深入教學現場與出版體系，剖析出題資訊斷層與長尾特教群體之客觀阻力</p>
          </div>
        </div>
        ...
        <div class="slide-body">
          <div class="grid-2">
            <!-- Left: 企業實務痛點 (調換至左邊) -->
            <div class="content-box-pill" style="border-top: 4px solid var(--terracotta-cta);">
              <span class="pill-badge pill-terra">企業實務痛點</span>
              <div class="card-h" style="font-size:1.25rem; color:var(--terracotta-cta); min-height:56px; display:flex; align-items:center;">
                課輔老師資訊不對稱，客製化成本過高
              </div>
              <div class="card-p" style="font-size:0.92rem; line-height:1.8; margin-top:8px;">
                <div style="margin-bottom:12px; display:flex; gap:8px;">
                  <span style="color:var(--terracotta-cta); font-weight:800;">•</span>
                  <span><strong>出題標準脫節：</strong>課輔老師與原班導師缺乏出題標準同步機制，僅能手握紙本課本摸索，難以精準評估課綱契合度。</span>
                </div>
                <div style="margin-bottom:12px; display:flex; gap:8px;">
                  <span style="color:var(--terracotta-cta); font-weight:800;">•</span>
                  <span><strong>備課耗時劇烈：</strong>針對 1~6 年級不同年齡層手工降難度出題，單次需消耗 1~2 小時備課，邊際產出極低。</span>
                </div>
                <div style="display:flex; gap:8px;">
                  <span style="color:var(--terracotta-cta); font-weight:800;">•</span>
                  <span><strong>認知鷹架缺失：</strong>傳統紙本人工出題難以動態提供詞根、色彩音節、卡拉OK語音等多元認知鷹架提示。</span>
                </div>
              </div>
            </div>

            <!-- Right: 目前困境 (調換至右邊，小標題對齊，內文增補完整平衡) -->
            <div class="content-box-pill" style="border-top: 4px solid var(--sage-primary);">
              <span class="pill-badge pill-green">目前困境</span>
              <div class="card-h" style="font-size:1.25rem; color:var(--sage-primary); min-height:56px; display:flex; align-items:center;">
                特定族群分散，無法評估確切需求
              </div>
              <div class="card-p" style="font-size:0.92rem; line-height:1.8; margin-top:8px;">
                <div style="margin-bottom:12px; display:flex; gap:8px;">
                  <span style="color:var(--sage-primary); font-weight:800;">•</span>
                  <span><strong>特教學童長尾分散：</strong>特殊需求學童散落在常態班級與不同社區課輔站點，出版端缺乏集中樣本蒐集常模。</span>
                </div>
                <div style="margin-bottom:12px; display:flex; gap:8px;">
                  <span style="color:var(--sage-primary); font-weight:800;">•</span>
                  <span><strong>缺乏客觀行為數據：</strong>學校與機構缺乏行為數據追蹤工具，僅以考卷成績評斷，無法量化注意力與工作記憶極限。</span>
                </div>
                <div style="display:flex; gap:8px;">
                  <span style="color:var(--sage-primary); font-weight:800;">•</span>
                  <span><strong>市場教材標準化失衡：</strong>主流數位教材均以常態學童為核心，特殊生長年處於輔具邊緣，無法獲得精準階梯支援。</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="slide-footer">
          <span>MAIN POINTS ｜ Slide 05 / 12</span>
          <span>結構平衡對比：備課時間過長、資訊斷層 ↔ 特定族群分散、缺乏客觀學習反饋</span>
        </div>
      </section>


      <!-- =========================================================================
           SLIDE 6: PROJECT & DEMO (專案架構：FocusLingua)
           ========================================================================= -->
      <section class="slide-card" id="slide-6">
        ...
        <div class="slide-footer">
          <span>PROJECT & DEMO ｜ Slide 06 / 12</span>
          <span>清晰雙端定位：老師端掌管審核與出題 ｜ 學生端提供極簡抗分心沙盒</span>
        </div>
      </section>


      <!-- =========================================================================
           SLIDE 7: PRODUCT EVOLUTION (產品演進脈絡分析 - 新增演進模型頁)
           ========================================================================= -->
      <section class="slide-card" id="slide-7">
        ...
        <div class="slide-header">
          <div>
            <div class="slide-pill-tag"><i class="fa-solid fa-route"></i> PRODUCT EVOLUTION</div>
            <h2 class="slide-title">產品演進脈絡分析</h2>
            <p class="slide-subtitle">不盲信技術，經歷兩代失敗原型的深刻反思，淬鍊出真正的 B2B2C 雙端解耦架構</p>
          </div>
        </div>
        ...
        <div class="slide-body">
          <div class="grid-4" style="margin-top: 4px;">
            <!-- Stage 1 -->
            <div class="content-box-pill" style="border-top: 4px solid #94A3B8; padding: 18px; justify-content:space-between;">
              <div>
                <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:8px;">
                  <span class="pill-badge" style="background:#F1F5F9; color:#475569; margin-bottom:0;">階段一</span>
                  <i class="fa-solid fa-lightbulb" style="color:#94A3B8;"></i>
                </div>
                <div class="card-h" style="font-size:1.02rem;">初步構思<br><small style="color:#64748B; font-size:0.8rem;">Initial Idea</small></div>
                <div class="card-p" style="font-size:0.82rem; margin-top:8px; line-height:1.6;">
                  • <strong>出發點：</strong>專為 ADHD 注意力不集中族群打造一款英語學習 App。<br>
                  • <strong>核心目標：</strong>解決他們比一般人學習時間過長（2倍以上）以及在常態課堂極易分心的問題。
                </div>
              </div>
              <div style="background:#F1F5F9; border-radius:8px; padding:8px 10px; font-size:0.75rem; color:#475569; margin-top:12px;">
                <strong>局限：</strong>初期僅有概念，缺乏第一線教學現場的具體載體。
              </div>
            </div>

            <!-- Stage 2 -->
            <div class="content-box-pill" style="border-top: 4px solid #EF4444; padding: 18px; justify-content:space-between;">
              <div>
                <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:8px;">
                  <span class="pill-badge" style="background:#FEE2E2; color:#DC2626; margin-bottom:0;">模型一</span>
                  <i class="fa-solid fa-triangle-exclamation" style="color:#DC2626;"></i>
                </div>
                <div class="card-h" style="font-size:1.02rem;">AI 工具原型摸索<br><small style="color:#64748B; font-size:0.8rem;">Stitch / Studio AI</small></div>
                <div class="card-p" style="font-size:0.82rem; margin-top:8px; line-height:1.6;">
                  • <strong>實作：</strong>使用 Agent, Claude, Stitch, Studio AI 等快速拼出第一版雛形。<br>
                  • <strong>失敗洞察：</strong><br>
                  1. 生成的介面僵硬不自然。<br>
                  2. 沒有切分年齡層，以為做「多階層自選」就好。<br>
                  3. 違反「簡潔」初衷，學生在選單就分心迷失！
                </div>
              </div>
              <div style="background:#FEF2F2; border-radius:8px; padding:8px 10px; font-size:0.75rem; color:#991B1B; margin-top:12px;">
                <strong>教訓：</strong>選項過多不是彈性，而是致命的認知干擾。
              </div>
            </div>

            <!-- Stage 3 -->
            <div class="content-box-pill" style="border-top: 4px solid var(--amber-reward); padding: 18px; justify-content:space-between;">
              <div>
                <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:8px;">
                  <span class="pill-badge pill-amber" style="margin-bottom:0;">模型二</span>
                  <i class="fa-solid fa-comments" style="color:var(--amber-reward);"></i>
                </div>
                <div class="card-h" style="font-size:1.02rem;">Chatbot 轉向與老師端萌芽<br><small style="color:#64748B; font-size:0.8rem;">Chatbot & Teacher Portal</small></div>
                <div class="card-p" style="font-size:0.82rem; margin-top:8px; line-height:1.6;">
                  • <strong>嘗試首頁 Chatbot：</strong>高額 Token 費用難以商業化，且學生端無結構引導效益極低。<br>
                  • <strong>關鍵轉向：加入「老師端」！</strong><br>
                  - 支援老師上傳課本/課綱檔案。<br>
                  - AI 秒級自動出題。<br>
                  - 老師可二次編輯，杜絕 AI 幻覺。<br>
                  - 建立學生即時數據追蹤。
              ...
              <div style="background:var(--amber-light); border-radius:8px; padding:8px 10px; font-size:0.75rem; color:#B45309; margin-top:12px;">
                <strong>突破：</strong>把出題權交還老師，確立系統核心支點。
              </div>
            </div>

            <!-- Stage 4 -->
            <div class="content-box-pill" style="border-top: 4px solid var(--sage-primary); padding: 18px; justify-content:space-between;">
              <div>
                <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:8px;">
                  <span class="pill-badge pill-green" style="margin-bottom:0;">最終架構</span>
                  <i class="fa-solid fa-diagram-project" style="color:var(--sage-primary);"></i>
                </div>
                <div class="card-h" style="font-size:1.02rem;">B2B2C 雙端方案<br><small style="color:#64748B; font-size:0.8rem;">Final Dual-End Architecture</small></div>
                <div class="card-p" style="font-size:0.82rem; margin-top:8px; line-height:1.6;">
                  • <strong>商業本質釐清：</strong>買單方是學校/補教/老師，學生是受惠使用者！<br>
                  • <strong>雙端工程：</strong><br>
                  - 老師端 (Web 動態網頁)：大螢幕操作，課綱秒切、二次審題、IEP 檔案匯出、全班熱區。<br>
                  - 學生端 (App 專注沙盒)：90 秒微任務、視覺卡片+3選1按鈕、完成即鎖定。
                </div>
              </div>
              <div style="background:var(--sage-light); border-radius:8px; padding:8px 10px; font-size:0.75rem; color:var(--sage-primary); margin-top:12px;">
                <strong>成果：</strong>完美契合學校採購與 ADHD 學生人因需求。
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="slide-footer">
          <span>PRODUCT EVOLUTION ｜ Slide 07 / 12</span>
          <span>經歷兩代試錯迭代 ➔ 確立「以老師減負為支點、學生沙盒為終端」之閉環</span>
        </div>
      </section>


      <!-- =========================================================================
           SLIDE 8: LIVE INTERACTIVE SANDBOX (雙端實操模擬)
           ========================================================================= -->
      ...
      <!-- =========================================================================
           SLIDE 9: COST-BENEFIT & ROI (導入效益分析 - 改為 Before 在左、After 在右對比)
           ========================================================================= -->
      <section class="slide-card" id="slide-9">
        ...
        <div class="slide-header">
          <div>
            ...
            <h2 class="slide-title">預測效益分析：導入前後對比</h2>
            <p class="slide-subtitle">本產品未經過實測，僅以本人教學觀察與人因邏輯判斷。</p>
          </div>
        </div>

        <div class="slide-body">
          <div class="grid-2">
            <!-- Left Card: BEFORE 導入前困境 -->
            <div class="content-box-pill" style="border-top: 4px solid #DC2626; background: #FFFBFA;">
              <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:14px;">
                <span class="pill-badge" style="background:#FEE2E2; color:#DC2626; margin-bottom:0; font-size:0.85rem; padding:5px 14px;">
                  <i class="fa-solid fa-circle-xmark" style="margin-right:6px;"></i> BEFORE 導入前傳統困境
                </span>
                <span style="font-size:0.75rem; color:#991B1B; font-weight:700;">人工手動 × 挫折循環</span>
              </div>

              <!-- Item 1 -->
              <div style="margin-bottom:16px;">
                <div style="font-size:0.98rem; font-weight:800; color:#991B1B; margin-bottom:4px; display:flex; align-items:center; gap:6px;">
                  <i class="fa-solid fa-clock-rotate-left"></i> 備課負擔沉重，資源嚴重錯配
                </div>
                <div class="card-p" style="color:#7F1D1D; font-size:0.88rem; line-height:1.7;">
                  課輔老師面對 1~6 年級特殊生，只能手翻紙本課本手工挑字降難度，單次出題耗費 <strong>90 分鐘以上</strong>。師資時間被繁重庶務綁架，難以提供細緻的情感陪伴。
                </div>
              </div>
              ...
              <div style="margin-bottom:16px;">
                <div style="font-size:0.98rem; font-weight:800; color:#991B1B; margin-bottom:4px; display:flex; align-items:center; gap:6px;">
                  <i class="fa-solid fa-brain"></i> 長題庫超載，挫折向家庭蔓延
                </div>
                <div class="card-p" style="color:#7F1D1D; font-size:0.88rem; line-height:1.7;">
                  市面題庫預設學童具備 15 分鐘專注耐受力。ADHD 學童前 3 分鐘即分心崩潰，<strong>衝動性亂按率高達 24%</strong>，排斥複習作業，最終將學習挫折與衝突帶回家中。
                </div>
              </div>
              ...
              <div>
                <div style="font-size:0.98rem; font-weight:800; color:#991B1B; margin-bottom:4px; display:flex; align-items:center; gap:6px;">
                  <i class="fa-solid fa-box-archive"></i> 單向零售教材邊際產出遞減
                </div>
                <div class="card-p" style="color:#7F1D1D; font-size:0.88rem; line-height:1.7;">
                  出版公司教材僅能在一般書店或常態課堂零售，缺乏客觀行為量化數據反饋，<strong>難以打入學校特教組、資源班與兒福機構</strong>之長期專案採購體系。
                </div>
              </div>
            </div>

            <!-- Right Card: AFTER 導入後預期效益 -->
            <div class="content-box-pill" style="border-top: 4px solid var(--sage-primary); background: #FAFCFA;">
              <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:14px;">
                <span class="pill-badge pill-green" style="margin-bottom:0; font-size:0.85rem; padding:5px 14px;">
                  <i class="fa-solid fa-circle-check" style="margin-right:6px;"></i> AFTER 導入 FocusLingua 後預期效益
                </span>
                <span style="font-size:0.75rem; color:var(--sage-primary); font-weight:700;">AI 減法賦能 × 閉環內化</span>
              </div>

              <!-- Item 1 -->
              <div style="margin-bottom:16px;">
                <div style="font-size:0.98rem; font-weight:800; color:var(--sage-primary); margin-bottom:4px; display:flex; align-items:center; gap:6px;">
                  <i class="fa-solid fa-bolt"></i> 備課成本顯著縮減 ｜ 營運效率優化
                </div>
                <div class="card-p" style="font-size:0.88rem; line-height:1.7;">
                  針對特殊生切片出題由原本 90 分鐘降至 <strong>30 秒生成 ＋ 5 分鐘審核</strong>。單一師資可服務之學童人次<strong>提升 3 倍以上</strong>，有效緩解課輔機構師資荒。
                </div>
              </div>
              ...
              <div style="margin-bottom:16px;">
                <div style="font-size:0.98rem; font-weight:800; color:var(--sage-primary); margin-bottom:4px; display:flex; align-items:center; gap:6px;">
                  <i class="fa-solid fa-seedling"></i> 課堂即時掌握核心詞彙 ｜ 人因成效驗證
                </div>
                <div class="card-p" style="font-size:0.88rem; line-height:1.7;">
                  嚴格限制在 90 秒黃金耐受期。在微型積木與即時鷹架下，學童<strong>衝動性亂點次數降低超過 60%</strong>，達成「課堂內直接消化、不將作業挫折帶回家」之目標。
                </div>
              </div>
              ...
              <div>
                <div style="font-size:0.98rem; font-weight:800; color:var(--sage-primary); margin-bottom:4px; display:flex; align-items:center; gap:6px;">
                  <i class="fa-solid fa-chart-line"></i> 打開新市場 ｜ 商業價值躍升 (Business Scalability)
                </div>
                <div class="card-p" style="font-size:0.88rem; line-height:1.7;">
                  升級為 B2B2C 雲端特教數據中樞，將傳統單向零售教材<strong>成功打入學校特教組、資源班與兒福課輔機構</strong>，活化版權並幫助更多慢飛天使受益。
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="slide-footer">
          <span>COST-BENEFIT & ROI ｜ Slide 09 / 12</span>
          <span>強烈對比：左側手工備課90分鐘與長題庫挫折 ➔ 右側30秒切片、90秒零挫折內化與融合教育藍海</span>
        </div>
      </section>


      <!-- =========================================================================
           SLIDE 10: FUTURE SCALABILITY (未來擴散性與再精進)
           ========================================================================= -->
      <section class="slide-card" id="slide-10">
        ...
        <div class="slide-footer">
          <span>FUTURE SCALABILITY ｜ Slide 10 / 12</span>
      ...
      <!-- =========================================================================
           SLIDE 11: PERSONAL REFLECTIONS (個人學習成果與反思)
           ========================================================================= -->
      <section class="slide-card" id="slide-11">
        ...
        <div class="slide-footer">
          <span>PERSONAL REFLECTIONS ｜ Slide 11 / 12</span>
      ...
      <!-- =========================================================================
           SLIDE 12: THANK YOU (結尾致謝)
           ========================================================================= -->
      <section class="slide-card" id="slide-12">
        <!-- Dot Matrices -->
        <div class="dot-matrix-tl">
          <div class="dot-item"></div><div class="dot-item"></div><div class="dot-item"></div><div class="dot-item"></div><div class="dot-item"></div>
          <div class="dot-item"></div><div class="dot-item"></div><div class="dot-item"></div><div class="dot-item"></div><div class="dot-item"></div>
        ...
        <div class="slide-body" style="display:flex; flex-direction:column; justify-content:center; align-items:center; text-align:center; min-height:550px;">
          <div class="fl-hero-icon-large" style="width:100px; height:100px; margin-bottom:20px;">
            <span class="fl-hero-icon-large-text" style="font-size:3rem;">FL</span>
            <div class="fl-hero-icon-large-sparkle" style="width:28px; height:28px;"><i class="fa-solid fa-sparkles"></i></div>
          </div>
          ...
          <div style="display:flex; gap:12px; flex-wrap:wrap; justify-content:center;">
            <button class="nav-btn" onclick="goToSlide(8)" style="background:var(--terracotta-cta); color:#fff; border:none; padding:10px 20px; font-size:0.9rem;">
              <i class="fa-solid fa-play"></i> 進入雙端實操模擬
            </button>
            <button class="nav-btn" onclick="goToSlide(2)" style="padding:10px 20px; font-size:0.9rem;">
              <i class="fa-solid fa-list-check"></i> 查看簡報目錄
            </button>
        ...
        <div class="slide-footer">
          <span>FocusLingua 成果專題簡報 ｜ Slide 12 / 12 ｜ 敬請指教</span>
...
print('Successfully generated pitch_presentation.html v2 with 12 slides, rotated photo, before-after, and balanced layout!')
